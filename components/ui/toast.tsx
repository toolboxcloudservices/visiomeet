...
import * as ToastPrimitives from "@radix-ui/react-toast"; // Radix UI Toast primitives for managing toast notifications
import { cva, type VariantProps } from "class-variance-authority"; // Utility for creating class variants
import { X } from "lucide-react"; // Icon from Lucide React

import { cn } from "@/lib/utils"; // Utility for class name merging and conditional logic

// ToastProvider: Wraps the toast system and provides the context
const ToastProvider = ToastPrimitives.Provider;

// ToastViewport: Defines the area where toasts are displayed
...
// Variants for the toast component (default and destructive)
...
// ToastAction: Action button inside a toast
...
// ToastTitle: Title section of a toast
...
// ToastDescription: Description section of a toast
...
// Export components and types for external usage
export {
  type ToastProps,
